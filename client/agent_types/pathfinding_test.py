...
class PathfindingTestAgent(BaseAgent):
    def __init__(self, agent_id: str, x: float, y: float, test_waypoints: List[Tuple[float, float]] = None):
        super().__init__(agent_id, x, y, "pathfinding_test")
        self.test_waypoints = test_waypoints or [(10, 10), (90, 10), (90, 90), (10, 90), (50, 50), (10, 10)]
