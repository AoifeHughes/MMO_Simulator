...
class Renderer:
    def __init__(self, screen_width: int = 1024, screen_height: int = 768):
        ...
        # Start with camera centered and zoomed out to show entire map
        self.camera_x = 0
        self.camera_y = 0
        self.zoom = 0.5  # Start zoomed out to show full map
    ...
    def render_frame(
        self, world_map, agents: List[Dict], focus_agent_id: Optional[str] = None
    ):
