...
class FogOfWar:
    ...
    def __init__(self, world_width: int, world_height: int):
        ...
        self.agent_vision: Dict[int, Set[Tuple[int, int]]] = (
            {}
        )  # agent_id -> visible tiles
        self.agent_memory: Dict[int, Dict[Tuple[int, int], Dict]] = (
            {}
        )  # agent_id -> tile -> info
    ...
    def _has_line_of_sight(
        self, x1: int, y1: int, x2: int, y2: int, world: World
    ) -> bool:
    ...
    def _update_agent_memory(
        self, agent: Entity, world: World, visible_tiles: Set[Tuple[int, int]]
    ) -> None:
    ...
    def get_remembered_tile_info(
        self, agent_id: int, position: Tuple[int, int]
    ) -> Optional[Dict]:
