...
TILE_PROPERTIES = {
    ...
    TileType.SAND: TileProperties(
        walkable=True, blocking_vision=False, movement_cost=1.5, color=(238, 203, 173)
    ),
    TileType.DIRT: TileProperties(
        walkable=True, blocking_vision=False, movement_cost=1.1, color=(139, 90, 43)
    ),
    TileType.WOOD: TileProperties(
        walkable=True, blocking_vision=False, movement_cost=1.0, color=(139, 69, 19)
    ),
    ...
    TileType.DOOR: TileProperties(
        walkable=True, blocking_vision=True, movement_cost=1.0, color=(139, 90, 0)
    ),
    TileType.BRIDGE: TileProperties(
        walkable=True, blocking_vision=False, movement_cost=1.0, color=(160, 82, 45)
    ),
